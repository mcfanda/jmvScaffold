...
Here you can find a how-to to build a `r jamovi` package using the R package [jmvScaffold](https://github.com/mcfanda/jmvScaffold), which provides several functions and R6 classes to ease the development of 
