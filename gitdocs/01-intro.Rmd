...
To program a jamovi module, you want to have a basic knowledge of [R6 classes](https://r6.r-lib.org/articles/Introduction.html). You do not need much, as it is very easy to work with them. R6 classes brings object oriented programming to R. R6 objects are basically functions that know themselves.
