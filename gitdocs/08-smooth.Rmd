...
One can program `r jamovi` modules freely with all techniques one wishes. If one wants to take advantage of `r jamovi` flexibility and `jmvScaffold` helping function, one can follow this guidelines:
